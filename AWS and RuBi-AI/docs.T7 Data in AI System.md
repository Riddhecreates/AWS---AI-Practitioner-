...
By the end of this topic, you must clearly understand:
	...
	•	How your RuBi-AI project uses real classroom data safely
...
RuBi-AI uses structured data for performance trends, unstructured data for feedback analysis, and semi-structured data from survey tools. High data quality is critical, because poor inputs directly produce misleading insights for teachers even when using AWS managed AI services.
...
•	What structured data does RuBi-AI collect?
- RuBi-AI collects structured data such as survey ratings, attendance records, and quiz scores. These follow fixed formats, making them easy to store and analyze for trends.

•	What unstructured data does RuBi-AI use?
- RuBi-AI uses unstructured data like student written feedback, teacher comments, and learning reflections. This data captures context and opinions that numbers alone cannot express.
...
You should clearly state:
	•	RuBi-AI uses real classroom data
